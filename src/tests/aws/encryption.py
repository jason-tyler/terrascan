...
class EncryptionTestGroup(TestGroup):
    ...
    def test_ami_ebs_block_device_encryption(self):
    ...
    def test_ami_copy_encryption(self):
    ...
    def test_api_gateway_domain_name_certificate(self):
    ...
    def test_instance_ebs_block_device_encrypted(self):
    ...
    def test_cloudfront_distribution_origin_protocol_policy(self):
    ...
    def test_cloudfront_distribution_def_cache_viewer_prot_policy(self):
    ...
    def test_cloudfront_distribution_cache_beh_viewer_proto_policy(self):
        # Assert that cache protocol doesn't allow all
        self.v.enable_variable_expansion()
        self.v.resources(
            'aws_cloudfront_distribution').property(
    ...
    def test_codebuild_project_kms(self):
        # Assert that a KMS key has been provided
        self.v.error_if_property_missing()
        self.v.enable_variable_expansion()
        self.v.resources(
    ...
    def test_codepipeline_kms(self):
        # Assert that a KMS key has been provided
        self.v.error_if_property_missing()
        self.v.enable_variable_expansion()
        self.v.resources(
    ...
    def test_dms_endpoint_ssl_mode(self):
    ...
    def test_dms_endpoint_kms(self):
        # Assert that a KMS key has been provided
        self.v.error_if_property_missing()
        self.v.enable_variable_expansion()
        self.v.resources(
    ...
    def test_dms_endpoint_certificate(self):
    ...
    def test_dms_replication_instance_kms(self):
        # Assert that a KMS key has been provided
        self.v.error_if_property_missing()
        self.v.enable_variable_expansion()
        self.v.resources(
    ...
    def test_efs_file_system_encryption(self):
    ...
    def test_efs_file_system_kms(self):
        # Assert that a KMS key has been provided
        self.v.error_if_property_missing()
        self.v.enable_variable_expansion()
        self.v.resources(
    ...
    def test_elastictranscoder_pipeline_kms(self):
        # Assert that a KMS key has been provided
        self.v.error_if_property_missing()
        self.v.enable_variable_expansion()
        self.v.resources(
    ...
    def test_elb_listener_port_80(self):
    ...
    def test_elb_listener_port_21(self):
    ...
    def test_elb_listener_port_23(self):
    ...
    def test_elb_listener_port_5900(self):
    ...
    def test_lambda_function_kms(self):
        # Assert that a KMS key has been provided
        self.v.error_if_property_missing()
        self.v.enable_variable_expansion()
        self.v.resources(
    ...
    def test_opsworks_application_encryption(self):
    ...
    def test_redshift_cluster_encryption(self):
        # Assert resource is encrypted
        self.v.error_if_property_missing()
        self.v.enable_variable_expansion()
        self.v.resources(
    ...
    def test_redshift_cluster_kms(self):
        # Assert resource has a KMS with CMKs
        self.v.error_if_property_missing()
        self.v.enable_variable_expansion()
        self.v.resources(
    ...
    def test_s3_bucket_object_encryption(self):
    ...
    def test_s3_bucket_object_kms(self):
        # Assert resource has a KMS with CMKs
        self.v.error_if_property_missing()
        self.v.enable_variable_expansion()
        self.v.resources(
    ...
    def test_ssm_parameter_encryption(self):
        # Assert resource is encrypted with KMS
        self.v.error_if_property_missing()
        self.v.enable_variable_expansion()
        self.v.resources(
    ...
    def test_ssm_parameter_kms(self):
        # Assert resource has a KMS with CMK
        self.v.error_if_property_missing()
        self.v.enable_variable_expansion()
        self.v.resources(
